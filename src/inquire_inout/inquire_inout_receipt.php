...
<div style="margin-bottom:8px; height:20px"> 精确查询：
  ...
  <input name="search" type="button" value="查找" onclick="location.href='../receipt_inout/receipt_show_inout.php?id=' + document.getElementById('receipt_id').value"/>
</div>
<!--精确查询框架-->
<!--查询框架-->
...
<div>
  <input name="" type="button" value="显示全部" onclick="location.href='inquire_inout_receipt.php'"/>
</div>
