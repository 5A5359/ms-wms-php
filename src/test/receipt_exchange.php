...
//    td6.innerHTML = price_str;
    td5.innerHTML = '<a onclick="removeRow(this)">删除</a>';
    td6.innerHTML = '<a onclick="editRow(this)">修改</a>';
    updateStr();//更新隐藏域的值
    //resetInput()//恢复默认的编辑框
...
function showRight(){//根据入库仓库，限定出库仓库
...
<body>
<form id="item_in" name="item_in" method="post" action="../test/receipt_exchange_bg.php" onsubmit=" return checkForm()">
  <h3>仓库调拨</h3>
  <fieldset>
  <legend>仓库信息</legend>
  <label>出货仓库</label>
  ...
  <a href="/wms/basic/warehouse/warehouse_show.php" target="_blank"><img src="/wms/image/delete.gif" alt="仓库管理" width="25" height="19" border="0"/></a>
  </fieldset>
  <fieldset>
  <legend>库存列表</legend>
